...
class DocuRAGException(Exception):
    def __init__(self,error_message,error_details:Optional[object]=None):
        ...
        self.file_no = last_tb.tb_frame.f_code.co_filename if last_tb else '<unknown>'
        ...
        def __repr__(self):
            return f"DocuRAGException(file={self.file_name!r}, line={self.lineno}, message={self.error_message!r})"

if __name__ == '__main__':
    try:
        1/0
    except Exception as e:
        raise DocuRAGException('Failed')